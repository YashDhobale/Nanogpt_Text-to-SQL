...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: '2rem auto', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <text style={{ color: '#666', marginTop: 0 }}>Responses can take upto 1-2 minutes to be generated due to computational constraints. Apologies for the long wait</text>
